...
* На стороне Рево формируются уникальный идентификатор сайта магазина и секретный ключ, которые далее передаются партнеру
* Для авторизации в сервисах Рево Партнёром используется <a href="#1c37860b3b">цифровая подпись</a>
* Партнер, отправляет `POST` запрос используя уникальный идентификатор магазина `store_id` и сформированую <a href="#1c37860b3b">цифровую подпись</a>
